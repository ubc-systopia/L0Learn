import fastsparsegams
 ...
 fit_model_2 = fastsparsegams.fit(X, y, penalty="L0L2", num_gamma = 5, gamma_min = 0.0001, gamma_max = 10, max_support_size=20)
 ...
 fit_model_3 = fastsparsegams.fit(X,y,loss="Logistic", max_support_size=20, algorithm="CDPSI")
...
################################################
 ...
 fit_model_3 = fastsparsegams.fit(X,y,loss="Exponential", max_support_size=20, algorithm="CDPSI")
